...
constexpr auto _MAX_KEY_COLUMNS = (256/32);
constexpr auto _MAX_ROUNDS = 14;
constexpr auto MAX_IV_SIZE = 16;
...
// Error codes
constexpr auto RIJNDAEL_SUCCESS = 0;
constexpr auto RIJNDAEL_UNSUPPORTED_MODE = -1;
constexpr auto RIJNDAEL_UNSUPPORTED_DIRECTION = -2;
constexpr auto RIJNDAEL_UNSUPPORTED_KEY_LENGTH = -3;
constexpr auto RIJNDAEL_BAD_KEY = -4;
constexpr auto RIJNDAEL_NOT_INITIALIZED = -5;
constexpr auto RIJNDAEL_BAD_DIRECTION = -6;
constexpr auto RIJNDAEL_CORRUPTED_DATA = -7;
